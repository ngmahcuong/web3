...
const errorMessages: Record<number, string> = {
  ...
  [TokenError.COMPTROLLER_REJECTION]: 'CHAI Comptroller rejection',
  [TokenError.COMPTROLLER_CALCULATION_ERROR]: 'CHAI Comptroller calculation error',
...
const failureMessages: Record<number, string> = {
  ...
  [TokenFailureInfo.BORROW_COMPTROLLER_REJECTION]: 'Borrow CHAI controller rejection',
